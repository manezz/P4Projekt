...
namespace WebApi.Migrations
{
    ...
    [Migration("20230220075151_initial")]
            ...
            modelBuilder.Entity("WebApi.Database.Entities.Liked", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            LikeUserId = 2,
                            PostId = 1,
                            LikedTime = new DateTime(2023, 2, 20, 8, 51, 51, 175, DateTimeKind.Local).AddTicks(1957)
                        });
                });
            ...
            modelBuilder.Entity("WebApi.Database.Entities.Posts", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PostId = 1,
                            Date = new DateTime(2023, 2, 20, 8, 51, 51, 175, DateTimeKind.Local).AddTicks(1941),
                            Desc = "tadnawdnada",
                            Likes = 1,
                            Title = "testestestest",
                            UserId = 1
                        ...
                        {
                            PostId = 2,
                            Date = new DateTime(2023, 2, 20, 8, 51, 51, 175, DateTimeKind.Local).AddTicks(1945),
                            Desc = "Woooooo!",
                            Likes = 0,
                            Title = "Test!",
                            UserId = 2
            ...
            modelBuilder.Entity("WebApi.Database.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            Created = new DateTime(2023, 2, 20, 8, 51, 51, 175, DateTimeKind.Local).AddTicks(1921),
                            LoginId = 1,
                            UserName = "tester 1"
                        },
                        new
                        {
                            UserId = 2,
                            Created = new DateTime(2023, 2, 20, 8, 51, 51, 175, DateTimeKind.Local).AddTicks(1925),
                            LoginId = 2,
                            UserName = "222test222"
                        });
                });
