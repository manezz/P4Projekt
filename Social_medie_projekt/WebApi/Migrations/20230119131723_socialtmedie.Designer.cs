...
namespace WebApi.Migrations
{
    ...
    [Migration("20230119131723_socialtmedie")]
            ...
            modelBuilder.Entity("WebApi.Database.Entities.Liked", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 2,
                            PostId = 1,
                            LikedTime = new DateTime(2023, 1, 19, 14, 17, 23, 701, DateTimeKind.Local).AddTicks(1287)
                        });
                });
            ...
            modelBuilder.Entity("WebApi.Database.Entities.Posts", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PostId = 1,
                            Date = new DateTime(2023, 1, 19, 14, 17, 23, 701, DateTimeKind.Local).AddTicks(1273),
                            Desc = "tadnawdnada",
                            Likes = 1,
                            Title = "testestestest",
                            UserId = 1
            ...
            modelBuilder.Entity("WebApi.Database.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            Address = "testvej 1",
                            Created = new DateTime(2023, 1, 19, 14, 17, 23, 701, DateTimeKind.Local).AddTicks(1251),
                            FirstName = "test",
                            LastName = "1",
                            LoginId = 1
                        },
                        new
                        {
                            UserId = 2,
                            Address = "testvej 2",
                            Created = new DateTime(2023, 1, 19, 14, 17, 23, 701, DateTimeKind.Local).AddTicks(1255),
                            FirstName = "test",
                            LastName = "2",
                            LoginId = 2
                        });
